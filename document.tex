...
\providecommand{\dinf}{\mathrm{d}}
\providecommand{\dd}[1]{\,\dinf #1}
\providecommand{\ddp}[2]{\,\dinf^{#2} #1}
\renewcommand{\dv}[1]{\frac{\dinf}{\dd{#1}}}
\providecommand{\dvv}[2]{\frac{\dd{#1}}{\dd{#2}}}
\providecommand{\dvvp}[3]{\frac{\ddp{#1}{#3}}{\ddp{#2}{#3}}}

\renewcommand{\eval}[1]{\left. #1 \right|}
%\renewcommand{\qty}[#3]{\left #1 #2 \right #3}
...
\label{cha:grav-radi}
\input{chapters/gravitational-radiation}


\chapter{Black Holes}
\label{cha:black-holes}
\input{chapters/blackhole}
